     ...
     <div className='mx-auto w-4/6 p-4'>{
      restaurantData?.length > 0 &&
        <div>
            ...
            <RestaurantDeals deals={restaurantData[3]?.card?.card?.gridElements?.infoWithStyle?.offers}/>
            <RestaurantRecommended recommended={restaurantData[4]?.groupedCard?.cardGroupMap?.REGULAR?.cards}/>
            <RecommendedFooter/>
        </div>
     }
    </div>
