  ...
  return (
    <div className="flex gap-4 px-6 py-4 shadow-md sticky top-0 bg-white z-10 font-bold text-gray-600">
      <div className="flex w-3/12 gap-10 items-center">
        ...
        <div className="cursor-pointer text-sm" onClick={PopupClick}>
          <span className=" mr-2 mb-2 underline hover:text-orange-500">
            Other
          </span>
          <span className="font-normal text-gray-500">{displayAddress}</span>
        </div>
      </div>
      <div className="flex w-9/12 justify-between items-center">
        ...
        <div className="flex items-center gap-2 cursor-pointer hover:text-orange-500 hover:text-orange-500">
          <span>
            <svg
              class="ppAwf"
              viewBox="5 -1 12 25"
