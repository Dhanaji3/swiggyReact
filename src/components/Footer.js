    ...
    <div className="">
      {id === "app_install_links" && (
        <div className="flex justify-between">
          <span className="text-2xl w-1/2">{title}</span>
          <span className="flex flex-end">
            <img
              className="w-44 h-14 "
              src={BASEIMGURL + androidAppImage}
              alt=""
            />
            <img
              className="w-44 h-14 ml-4"
              src={BASEIMGURL + iosAppImage}
              alt=""
            />
          </span>
        </div>
        ...
        <div className="mt-16">
          <ul className="flex justify-between text-lg">
            <li>
              ...
              <span className="mt-2 text-gray-400 text-sm font-semibold">
                © 2024 Swiggy Limited
              </span>
            </li>
            <li>
              ...
              <div className="font-normal text-base text-gray-500">
                ...
                <div className="py-2">Swiggy Corporate</div>
                <div className="py-2">Careers</div>
                <div className="py-2">Team</div>
                <div className="py-2">Swiggy One</div>
                <div className="py-2">Swiggy Instamart</div>
                <div className="py-2">Swiggy Dineout</div>
                <div className="py-2">Swiggy Genie</div>
              </div>
            </li>
            <li>
              <div>Contact us</div>
              <div className="font-normal text-base text-gray-500">
                <div className="py-2">Help & Support</div>
                <div className="py-2">Partner with us</div>
                <div className="py-2">Ride with us</div>
              </div>
              <div className="mt-8">Legal</div>
              <div className="font-normal text-base text-gray-500">
                <div className="py-2">Terms & Conditions</div>
                <div className="py-2">Cookie Policy</div>
                <div className="py-2">Privacy Policy</div>
                <div className="py-2">Investor Relations</div>
              </div>
            </li>
            <li>
              Available in:
              {displayCities &&
                displayCities?.map((city, index) => {
                  return (
                    <div
                      key={index}
                      className="py-2 font-normal text-base text-gray-500"
                    >
                      {city?.text}
                    </div>
                  );
            ...
            <li>
              <div className="">Life at Swiggy</div>
              <div className="font-normal text-base text-gray-500">
                <div className="py-2">Explore with Swiggy</div>
                <div className="py-2">Swiggy News</div>
                <div className="py-2">Snackables</div>
              </div>
            </li>
          </ul>
        </div>
