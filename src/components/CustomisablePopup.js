        ...
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:text-left">
                ...
                {groups &&
                  groups?.map((group) => {
                    ...
                    return (
                      <>
                        <div className="font-bold text-sm my-4 border-t-2 pt-4">
                          {name}
                        </div>
                ...
                {addOns.map((item) => {
                  ...
                  return (
                    <>
                      <div className="font-bold text-base my-4 border-t-2 pt-4">
                        {groupName}
                      </div>
                      <div className="bg-white rounded-xl p-4">
                        {choices &&
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex  sm:px-6">
              ...
              <button
                type="button"
                className="inline-flex w-full justify-center rounded-md bg-green-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-700 sm:ml-3 sm:w-auto"
              >
                Continue
              </button>
            </div>
